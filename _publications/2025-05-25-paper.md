...
permalink: /publication/2025-05-25-paper
excerpt: 'Architecture‑dependent, non-asymptotic regret bounds that can be sharpened under a simple margin condition (when human preferences are more "clear" than you think).'
date: 2026-01-02
venue: 'KDD'
thumbnail: /images/rlhf_ppt.png
paperurl: ''
citation: 'Luo, Y., Ge, Y., Han, R. & Shen, G. (2026). Learning Guarantee of Reward Modeling Using Deep Neural Networks. SIGKDD2026 Research Track (to appear).'
---
